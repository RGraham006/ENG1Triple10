...
public class Customer extends Sprite implements Person{
    ...
    /**
     * Initialises the customer and certain variables that we are going
     * to use to interact with the game. We also set the spawn randomiser
     * and the interval between when each customer arrives
    ...
    /**
     * Gets the move of the customer and direction and sets the animations
     * accordingly
     * 
    ...
    /**
     * Draws the customer batch onto the screen given its x and y and direction
     * variables
