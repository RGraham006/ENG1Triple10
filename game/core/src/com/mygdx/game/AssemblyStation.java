...
public class AssemblyStation {
  ...
  public void assembleDish() {
    ...
    if (currentIngredients.contains("lettuce") && currentIngredients.contains("onion")
        && currentIngredients.contains("tomato")) {
      this.dish = "salad";
      assembled = true;
      this.clearIngredients();
    }
    if (currentIngredients.contains("patty") && currentIngredients.contains("bun")
        && currentIngredients.contains("tomato") && currentIngredients.contains("onion")) {
      this.dish = "burger";
      assembled = true;
      this.clearIngredients();
    }
