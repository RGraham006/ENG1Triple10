...
/**
 * Creates an ingredient that can be picked up and transferred between chefs and stations;
 * can also have its state changed by a station;
 *
 * @author Robin Graham
 */
public class Ingredient {
    ...
    /**
     * Creates the ingredient with a certain name;
     * all ingredients start unprocessed;
     *
